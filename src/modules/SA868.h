...
public:
     ...
     * constructor
     *
     * @param[in] pttPin Transmit / receive control pin, "0" is transmit; "1" is receive, the default receive mode
    ...
    /**
     * Get the frequency of the current scan
     ...
     * Set the working parameters of the module
     *
    ...
    /**
     * Set volume level
     * Set the volume level of the module
     *
    ...
    /**
     * get signal strength
     * get the module signal strength
     */
    int getRSSI();

    /**
     * set filter
     * set the filter of the module
     * @param[in] emphasis PRE/DE-EMPH, 0 means pre-emphasis/de-emphasis on, 1 means pre-emphasis/de-emphasis off;
     * @param[in] highPass 0 means high-pass filter on, 1 means high-pass filter off
     * @param[in] lowPass 0 means low-pass filter on, 1 means low-pass filter off
     *
     * @return
     * - true success
     * - false fail
